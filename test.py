...
if __name__ == '__main__':
    ...
    for i in range(0,3):
	    ...
	    myDate[myDateIndices[i]] = 10 * agi.execute(pystrix.agi.core.WaitForDigit(timeout=-1)
	    myDate[myDateIndices[i]] = myDate[myDateIndices[i]] + agi.execute(pystrix.agi.core.WaitForDigit(timeout=-1)
	    bound=boundaries[i]
